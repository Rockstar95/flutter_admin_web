...
MyLearningPlusRequest myLearnPlusRequestFromJson(String str) =>
    MyLearningPlusRequest.fromJson(json.decode(str));

String myLearnPlusRequestToJson(MyLearningPlusRequest data) =>
    json.encode(data.toJson());

class MyLearningPlusRequest {
  MyLearningPlusRequest(
      {this.pageIndex = 0,
      this.pageSize = 0,
      this.searchText = "",
      this.source = 0,
  ...
  factory MyLearningPlusRequest.fromJson(Map<String, dynamic> json) =>
      MyLearningPlusRequest(
