...
CatalogDetailsResponse catalogDetailsResponseFromJson(dynamic str) =>
    CatalogDetailsResponse.fromJson(json.decode(str));

dynamic catalogDetailsResponseToJson(CatalogDetailsResponse data) =>
    json.encode(data.toJson());

class CatalogDetailsResponse {
  ...
  bool isBookingOpened;
  dynamic downloadLink;
  bool isShowEventFullStatus;
  dynamic viewType;
  dynamic typeofEvent;
  dynamic startpage;
  dynamic folderPath;
  ...
  bool bit5;
  bool bit4;
  bool openNewBrowserWindow;
  dynamic salepricestrikeoff;
  dynamic sharelink;
  dynamic creditScoreWithCreditTypes;
  dynamic creditScoreFirstPrefix;
  dynamic mediaTypeId;
  dynamic ShareContentwithUser;

  factory CatalogDetailsResponse.fromJson(Map<dynamic, dynamic> json) =>
      CatalogDetailsResponse(
        isSuccess: json["IsSuccess"] ?? false,
        noRecord: json["NoRecord"] ?? false,
        ...
        isBookingOpened: json["isBookingOpened"] ?? false,
        downloadLink: json["DownloadLink"],
        isShowEventFullStatus: json["isShowEventFullStatus"] ?? false,
        ...
        openNewBrowserWindow: json["OpenNewBrowserWindow"] ?? false,
...
class RecordingDetails {
  ...
  factory RecordingDetails.fromJson(Map<dynamic, dynamic> json) =>
      RecordingDetails(
        eventRecording: json["EventRecording"] ?? false,
