...
void main() async {
  ...
  await runZoned<Future<Null>>(() async {
    ...
    runApp(App(
      mainSiteUrl: "https://elearning.instancy.net/",
      appAuthURL: "https://masterapi.instancy.net/api/",
      appWebApiUrl: "https://elearningapi.instancy.net/api/",
      splashScreenLogo: "assets/images/marketplacelogo.png",
    ));
  },
